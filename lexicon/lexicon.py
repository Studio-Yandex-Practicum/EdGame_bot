LEXICON_RU = {
    ...
    'hello_message': 'Я - бот, буду тебе помогать выполнять ачивки, получать баллы и '
                     'отслеживать свой прогресс по ходу обучения! Ты можешь управлять мной '
                     'с помощью кнопок, поэтому не будем медлить - выбирай нужный раздел!',
