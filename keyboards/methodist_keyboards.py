...
def task_keyboard_methodist(language: str) -> InlineKeyboardMarkup:
    ...
    achievement_list = InlineKeyboardButton(
        text=buttons["back"],
        callback_data='back_to_achievement_list')
    edit_task = InlineKeyboardButton(
        text=buttons["edit_task"], callback_data='edit_task')
    keyboard = [
        [edit_task],
...
def review_keyboard_methodist(
        language: str, cd: str) -> InlineKeyboardMarkup:
...
def choose_member_keyboard(language: str,
                           cd: str = None) -> InlineKeyboardMarkup:
...
def delete_user_from_team_keyboard(language: str,
                                   cd: str = None) -> InlineKeyboardMarkup:
    """
...
def team_limit_reached_keyboard(language: str,
                                cd: str = None) -> InlineKeyboardMarkup:
    """Клавиатура при просмотре информации о ребенке."""
    buttons = BUTTONS[language]
    back = InlineKeyboardButton(
...
def choice_tasks_for_review_keyboard(
